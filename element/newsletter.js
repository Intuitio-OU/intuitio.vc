				...
				<div className="row align-items-center">
					...
					<div className="col-lg-8 col-md-7 wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.4s">
						<div className="section-head style-1 text-white">
							...
							<h2 className="title m-b15">Subscribe To Our Newsletter For Latest Update </h2>
							<p>INDUSTRIE 4.0 opens the door to an age of ‘smart industry’ in which people, devices, objects, and systems combine to form dynamic, self-organizing networks of production.</p>
						</div>
